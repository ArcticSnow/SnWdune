...
if os.name == 'nt':
    ...
    if os.path.isfile ("config.txt"):
        ...
        outShad_dir = confile.readline()    [:-1]
...
def configWrite():
    ...
    global outSurf_dir, outBsmt_dir, inSurf_dir, inBsmt_dir, version, outShad_dir
...
def setOutShad():
    ...
    if outShad != "":
        ...
        if os.name == 'nt':
            # split up the outSurf string to open dialog in correct directory
            shadSplit = outShad.split ("/")
            outShad_dir = "/".join (shadSplit [0:(len (shadSplit) - 1)])
            status.config (text = "Output shadow file set: " + outShad)
    ...
    # else, the user selected 'Cancel', print an error message on the status bar
        ...
        status.config (text = "ERROR: Failed to set output shadow file")
...
def runModel():
    ...
    if outSurf == "" or outBsmt == "" or outShad == "":
...
p1a = Label (parFrame, text = "Number of intermediate graph:")
p1a_2 = Entry (parFrame, width = 10)
...
p1a.grid        (row = 11, column = 0, sticky = W, padx = 2, pady = 2)
p1a_2.grid      (row = 11, column = 1, sticky = W, padx = 2, pady = 2)
p12.grid        (row = 12, column = 0, sticky = W, padx = 2, pady = 2)
p12_2.grid      (row = 12, column = 1, sticky = W, padx = 2, pady = 2)
p13.grid        (row = 13, column = 0, sticky = W, padx = 2, pady = 2)
p13_2.grid      (row = 13, column = 1, sticky = W, padx = 2, pady = 2)
p14.grid        (row = 14, column = 0, sticky = W, padx = 2, pady = 2)
p14_2.grid      (row = 14, column = 1, sticky = W, padx = 2, pady = 2)
p15.grid        (row = 15, column = 0, sticky = W, padx = 2, pady = 2)
p15_2.grid      (row = 15, column = 1, sticky = W, padx = 2, pady = 2)
p16.grid        (row = 16, column = 0, sticky = W, padx = 2, pady = 2)
p16_2.grid      (row = 16, column = 1, sticky = W, padx = 2, pady = 2)
p17.grid        (row = 17, column = 0, sticky = W, padx = 2, pady = 2)
p17_2.grid      (row = 17, column = 1, sticky = W, padx = 2, pady = 2)
p18_2.grid      (row = 18, column = 1, sticky = W, padx = 2, pady = 2)
p19.grid        (row = 19, column = 0, sticky = W, padx = 2, pady = 2)
p19_2.grid      (row = 19, column = 1, sticky = W, padx = 2, pady = 2)
p20.grid        (row = 20, column = 0, sticky = W, padx = 2, pady = 2)
